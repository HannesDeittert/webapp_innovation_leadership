...
class ResearchDetailedPage extends StatelessWidget {


  ResearchDetailedPage(this.Research, this.Hub);

  final HubWork Research;
  ...
  Widget build(BuildContext context) {
    ...
    DetailedHubInfo info = detailedHubInfoProvider.detailedInnovationHub;
    String Cost = "Paid";
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        FutureBuilder(
                          future: _loadProfileImage(Research.TitleImage),
                          builder: (context, snapshot) {
